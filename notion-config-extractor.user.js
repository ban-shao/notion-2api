// ==UserScript==
// @name         Notion-2API 配置提取器 (增强版 v2.3)
// @namespace    http://tampermonkey.net/
// @version      2.3
// @description  自动提取 Notion 配置信息，增强版 v2.3可以监听网络请求，改进 token_v2 获取
// @author       You
// 
...
(function() {
   'use strict';
    ...
    // 🔧 用户自定义配置 - 请修改以下信息为您自己的
    const USER_NAME = 'Your Name';  // 修改为您的姓名
    const USER_EMAIL = 'your-email@example.com';  // 修改为您的邮箱
...
`;
        ...
        return `# [自动提取] notion-2api 配置文件 (增强版 v2.3)
# 提取时间: ${timestamp}
# 生成者: ${USER_NAME} (${USER_EMAIL})
${debugInfo}
# --- 安全配置 ---
API_MASTER_KEY=1
...
# 7. 可选：客户端版本 (保持默认即可)
NOTION_CLIENT_VERSION="23.13.2.3.2011.2037"
...
# 2. 增强版 v2.3插件会自动监听网络请求并获取 Space ID 和 User ID
# 3. 请查看浏览器控制台的日志信息`;
    }
    ...
    function extractAndShow() {
        ...
        content.innerHTML = `
            <h3 style="margin-top: 0; color: #333;">🚀 Notion-2API 配置提取器 (增强版 v2.3)</h3>
            ${statusHtml}
            ...
            <div style="margin-top: 15px; font-size: 12px; color: #666; line-height: 1.5;">
                ...
                1. 增强版 v2.3会自动监听网络请求获取 Space ID 和 User ID<br>
    ...
    function init() {
        ...
        setTimeout(() => {
            createButton();
            console.log('🚀 Notion-2API 配置提取器(增强版 v2.3)已加载');
